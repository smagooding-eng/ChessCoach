...
//   DATABASE_URL="..." node lib/db/scripts/import-lichess-puzzles.mjs path/to/curated_puzzles.csv
//
// Lives inside lib/db specifically so Node's module resolution finds the
// `pg` package, which is a dependency of lib/db (not of a top-level
// scripts/ folder, which has no node_modules of its own in this pnpm
// monorepo layout).
