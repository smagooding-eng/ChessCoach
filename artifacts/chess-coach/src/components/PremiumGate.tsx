...
export function PremiumGate({ children, feature }: PremiumGateProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
      ...
      <Link href="/subscription" className="flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold text-sm text-white transition-opacity hover:opacity-90" style={{ background: CHESSCOM_GREEN }}>
