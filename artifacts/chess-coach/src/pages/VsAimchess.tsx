...
export default function VsAimchessPage() {
  return (
    <VsPage
      ...
      title="ChessScout vs Aimchess — Honest Comparison"
      metaDescription="How ChessScout compares to Aimchess on price, features, and opponent scouting."
      canonicalPath="/vs/aimchess"
      intro="Aimchess is a well-established chess analytics tool that diagnoses weaknesses across six dimensions (opening accuracy, time management, resourcefulness, endgame conversion, advantage capitalization, and blunder prevention) and builds training around them. Here's how it compares to ChessScout, honestly."
      rows={[
