  ...
  return (
    ...
    <div className="space-y-6 pb-20 px-4 pt-4 md:px-0 md:pt-0">
      ...
      <div className="flex gap-2 overflow-x-auto pb-1">
        {TABS.map(tab => (
          <button
            ...
            className={cn(
              'flex items-center gap-2 px-4 py-2.5 rounded-md text-sm font-semibold border transition-all whitespace-nowrap shrink-0',
              activeTab === tab.id
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <div className="glass-card rounded-md p-5 md:p-6 mb-6 border border-white/5">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              ...
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 rounded-md font-bold bg-primary text-primary-foreground shadow-lg shadow-primary/25 hover:shadow-primary/40 hover:-translate-y-0.5 active:translate-y-0 transition-all disabled:opacity-50 disabled:cursor-not-allowed text-sm shrink-0"
              >
          ...
          {tabCourses.length > 0 ? (
              ...
              {tabCourses.map((course, i) => {
                ...
                return (
                  <motion.div
                    ...
                    key={course.id}
                    className="glass-card rounded-md p-5 flex flex-col h-full group border-white/5 hover:border-primary/30 transition-colors"
                  >
            ...
            <div className="text-center py-16 border-2 border-dashed border-border rounded-md">
              ...
              <button
                onClick={() => handleGenerate(currentTab.apiType)}
                disabled={!!generatingType}
                className="px-5 py-2.5 rounded-md bg-primary text-primary-foreground font-bold text-sm hover:shadow-lg hover:shadow-primary/25 hover:-translate-y-0.5 transition-all disabled:opacity-50"
              >
                Generate Now
              </button>
            </div>
