    ...
    <div className="max-w-lg mx-auto px-4 py-6 space-y-4">
      ...
      {state === 'idle' && (
        <div className="space-y-3">
          <div
            ...
            className="glass-card rounded-[2rem] p-8 border border-white/10 hover:border-primary/30 transition-all cursor-pointer flex flex-col items-center gap-3 active:scale-[0.98]"
          >
            <div className="w-14 h-14 rounded-[2rem] flex items-center justify-center" style={{ background: 'rgba(129,182,76,0.12)' }}>
          ...
          <div
            ...
            className="glass-card rounded-[2rem] p-6 border border-white/10 hover:border-primary/30 transition-all cursor-pointer flex items-center gap-4 active:scale-[0.98]"
          >
            <div className="w-11 h-11 rounded-3xl flex items-center justify-center shrink-0" style={{ background: 'rgba(129,182,76,0.12)' }}>
      ...
      {state === 'scanning' && (
        <div className="space-y-4">
          ...
          <div className="glass-card rounded-3xl px-4 py-5 border border-primary/30 bg-primary/5 flex items-center gap-3">
      ...
      {state === 'error' && (
        <div className="space-y-3">
          ...
          <div className="glass-card rounded-3xl px-4 py-3 border border-rose-500/30 bg-rose-500/5 flex items-center gap-3">
            <AlertCircle className="w-5 h-5 text-rose-400 shrink-0" />
            <p className="text-sm text-rose-400 flex-1">{error}</p>
          </div>
          <button
            onClick={resetAll}
            className="w-full py-3 rounded-3xl font-bold text-sm transition-all active:scale-[0.97] border border-white/10 hover:border-primary/30 text-white/60 hover:text-white"
          >
            Try Again
          </button>
        </div>
      ...
      {state === 'result' && mode === 'preview' && (
        <div className="space-y-3">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute top-2 left-2 z-10 p-1.5 rounded-[2rem] bg-black/60 backdrop-blur-sm border border-white/10 hover:border-primary/30 transition-all"
                  title="Flip board"
                >
          ...
          <div className={`rounded-3xl px-3 py-2 border text-xs flex items-center gap-2 ${confidenceBg}`}>
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="py-3 rounded-3xl font-bold text-sm transition-all active:scale-[0.97] flex items-center justify-center gap-2"
          ...
          <button
            onClick={resetAll}
            className="w-full py-2.5 rounded-3xl text-xs font-bold text-white/40 hover:text-white/60 transition-all flex items-center justify-center gap-1.5"
          >
      ...
      {state === 'result' && mode === 'explore' && (
        <div className="space-y-3">
          <div className="relative">
            ...
            {gameStatus && (
              <div className="absolute inset-0 rounded-[10px] flex items-center justify-center bg-black/50 pointer-events-none">
                <div className="px-5 py-3 rounded-3xl bg-amber-500/20 border border-amber-500/40 backdrop-blur-sm">
          ...
          {moveHistory.length > 0 && (
            <div className="glass-card rounded-3xl px-3 py-2 border border-white/10 flex items-center gap-2">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 py-2.5 rounded-3xl text-xs font-bold transition-all active:scale-[0.97] flex items-center justify-center gap-1.5 border border-white/10 hover:border-primary/30 text-white/50 disabled:opacity-30"
            >
            ...
            <button
              ...
              className="flex-1 py-2.5 rounded-3xl text-xs font-bold transition-all active:scale-[0.97] flex items-center justify-center gap-1.5"
              style={{ background: 'rgba(129,182,76,0.15)', color: '#81b64c', border: '1px solid rgba(129,182,76,0.3)' }}
            >
      ...
      {state === 'builder' && (
        <div className="space-y-3">
          ...
          <div className="rounded-3xl px-3 py-2 border border-white/10 bg-white/5 text-[11px] text-white/60 text-center">
            {builderPiece ? (
          ...
          <div className="space-y-1.5">
            <div className="grid grid-cols-6 gap-1">
              {['K','Q','R','B','N','P'].map(p => (
                <button
                  ...
                  className="aspect-square rounded-[2rem] flex items-center justify-center text-[clamp(20px,5vw,32px)] leading-none transition-all"
                  style={{
            ...
            <div className="grid grid-cols-3 gap-1">
              <button
                ...
                className="py-2 rounded-[2rem] text-xs font-bold flex items-center justify-center gap-1.5 transition-all"
                style={{
              ...
              <button
                ...
                className="py-2 rounded-[2rem] text-xs font-bold border border-white/10 hover:border-white/30 text-white/70 transition-all"
              >
                Clear Board
              </button>
              <button
          ...
          {/* Side to move */}
          <div className="flex items-center gap-2 rounded-3xl border border-white/10 bg-white/5 p-1">
            ...
            <button
              ...
              className="flex-1 py-1.5 rounded-[2rem] text-xs font-bold transition-all"
              style={{
          ...
          {builderError && (
            <div className="rounded-3xl px-3 py-2 border border-rose-500/30 bg-rose-500/5 flex items-center gap-2">
