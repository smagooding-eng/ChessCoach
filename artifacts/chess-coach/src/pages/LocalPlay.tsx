          ...
          <div className="grid grid-cols-2 gap-3">
            {TIME_OPTIONS.map(tc => (
              <motion.button
                ...
                className="glass-card rounded-3xl p-4 text-center border border-border hover:border-primary/40 transition-colors"
              >
      ...
      <div className="flex flex-col items-center gap-2 max-w-[580px] mx-auto">
        ...
        <div className="w-full rotate-180">
          <div className="flex items-center gap-2 w-full">
            {hasTimer && (
              <div className={cn(
                'px-3 py-1.5 rounded-[2rem] font-mono font-bold text-lg flex-1',
            ...
            {result === 'playing' && (
              <button
                onClick={() => resign('b')}
                className="flex items-center gap-1.5 px-3 py-2 rounded-[2rem] bg-red-500/10 border border-red-500/20 text-red-400 text-xs font-medium hover:bg-red-500/20 transition-colors shrink-0"
              >
        ...
        <AnimatePresence>
          {result !== 'playing' && (
            <motion.div
              ...
              className="glass-card rounded-3xl p-5 text-center space-y-3 w-full"
            >
              ...
              <button
                onClick={resetGame}
                className="px-4 py-2 bg-primary text-primary-foreground font-bold rounded-3xl text-sm"
              >
