...
export function Analysis() {
  ...
  return (
    ...
    <div className="space-y-5 pb-10 px-3 pt-3 md:px-0 md:pt-0">
      <div className="rounded-3xl p-5 md:p-6" style={{ background: BG_CARD, border: CARD_BORDER, boxShadow: CARD_SHADOW }}>
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <button
            ...
            className="shrink-0 px-5 py-2.5 rounded-[2rem] font-bold text-sm text-white flex items-center gap-2 transition-opacity hover:opacity-90 disabled:opacity-50"
      ...
      {isAnalyzing && statusMsg && (
        <motion.div
          ...
          className="p-3.5 rounded-[2rem] flex items-center gap-3 text-sm"
      ...
      {analyzeError && (
        <motion.div
          initial={{ opacity: 0, y: -8 }}
          animate={{ opacity: 1, y: 0 }}
          className="p-3.5 rounded-[2rem] flex items-center gap-2 text-sm"
      ...
      {(loadingSummary || loadingWeaknesses) && !isAnalyzing ? (
        ...
        <>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div className="rounded-3xl p-5 space-y-6" style={{ background: BG_CARD, border: CARD_BORDER, boxShadow: CARD_SHADOW }}>
            ...
            <div className="rounded-3xl p-5" style={{ background: BG_CARD, border: CARD_BORDER, boxShadow: CARD_SHADOW }}>
              ...
              <div className="space-y-2">
                {openingData.map((o, i) => (
                  <motion.div
                    ...
                    className="flex items-center gap-3 p-2.5 rounded-[2rem] cursor-pointer group transition-colors"
          ...
          {summary.avgRating > 0 && (() => {
            ...
            const progress = nextTier
              ...
              : 100;
            return (
              <div className="rounded-3xl overflow-hidden" style={{ background: BG_CARD, border: CARD_BORDER, boxShadow: CARD_SHADOW }}>
                <div className="px-5 py-4 flex flex-col sm:flex-row items-start sm:items-center gap-3 justify-between" style={{ borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                  ...
                  <div className="flex items-center gap-2.5">
                    <div className={`px-2.5 py-1 rounded-[2rem] text-xs font-bold ${tier.bgColor} ${tier.color} border ${tier.borderColor}`}>
                      {tier.icon} {tier.label}
                    </div>
                    {nextTier && (
                      <>
                        <ArrowUpRight className="w-3.5 h-3.5" style={{ color: TEXT_MUTED }} />
                        <div className={`px-2.5 py-1 rounded-[2rem] text-xs font-bold ${nextTier.bgColor} ${nextTier.color} border ${nextTier.borderColor} opacity-60`}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5">
                    {tier.tips.map((tip, i) => (
                      <motion.div
                        ...
                        className="flex gap-2.5 p-3 rounded-[2rem] transition-colors"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {weaknessesData?.weaknesses?.map((weakness, i) => (
              <motion.div
                ...
                className="rounded-3xl p-5 cursor-pointer group transition-all"
                style={{
                  background: BG_CARD,
            ...
            {!weaknessesData?.weaknesses?.length && (
              <div className="col-span-full text-center py-10 rounded-3xl text-sm" style={{ border: '1px dashed rgba(255,255,255,0.1)', color: TEXT_MUTED }}>
