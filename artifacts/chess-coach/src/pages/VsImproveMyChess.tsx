...
export default function VsImproveMyChessPage() {
  return (
    <VsPage
      ...
      title="ChessScout.net vs Improve My Chess — Honest Comparison"
      metaDescription="How ChessScout.net compares to Improve My Chess on price, features, and opponent scouting."
      canonicalPath="/vs/improve-my-chess"
      intro="Improve My Chess uses Stockfish plus an AI (Claude) to explain your blunders in plain English, and offers opponent scouting and personalized drills through a credit-based system — every feature spends from the same credit pool. Here's how it compares to ChessScout.net, honestly."
      rows={[
      ...
      honestNote="Improve My Chess is a genuinely similar product with a similar philosophy — using AI to explain mistakes in plain language rather than raw engine output. The biggest practical difference is pricing structure: ChessScout.net has one flat monthly price with generous free-tier limits, while Improve My Chess uses a shared credit pool where every analysis and scout draws down the same balance. If you'd rather pay a flat rate and not think about credits, that's where ChessScout.net differs most."
    />
  );
}
