...
import { ArrowRight, Mail, Eye, EyeOff, UserPlus, LogIn, Search, BarChart3, Brain, TrendingUp, Check, X, Target, Crosshair, BookOpen, Gamepad2, Flame, Download as DownloadIcon, Smartphone } from 'lucide-react';
