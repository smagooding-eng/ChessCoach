  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute -top-3 -left-3 px-2.5 py-1 rounded-md text-[10px] font-black tracking-wider"
      ...
      <motion.div
        ...
        className="absolute -bottom-3 -right-3 px-2.5 py-1 rounded-md text-[10px] font-black tracking-wider"
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="w-full max-w-md rounded-md relative p-8"
        ...
        >
          ...
          {googleAvailable && (
            <>
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-md border transition-colors font-medium mb-4"
          ...
          {error && (
            <div className="mb-4 p-3 rounded-md text-sm" style={{ background: 'rgba(220,67,67,0.1)', border: '1px solid rgba(220,67,67,0.25)', color: '#ef6b6b' }}>{error}</div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="you@example.com" required
                  className="w-full pl-10 pr-4 py-3 rounded-md text-sm outline-none transition-all"
                  style={{ background: 'rgba(255,255,255,0.05)', border: '2px solid rgba(255,255,255,0.08)', color: TEXT }}
                  onFocus={e => (e.target.style.borderColor = G)}
                  onBlur={e => (e.target.style.borderColor = 'rgba(255,255,255,0.08)')} />
              </div>
            ...
            <button type="submit" disabled={loading}
              className="w-full group flex items-center justify-center gap-2 py-3.5 rounded-md font-bold text-sm transition-all mt-2"
    ...
    >
      ...
      <div className="space-y-2.5">
        {[
          ...
          <div key={w.label} className="py-2.5 px-3 rounded-md" style={{ background: `${w.color}08`, border: `1px solid ${w.color}25` }}>
      ...
      <div className="mt-4 py-3 px-3.5 rounded-md" style={{ background: `${G}10`, border: `1px solid ${G}25` }}>
  ...
  return (
    <div className="min-h-screen overflow-x-hidden" style={{ background: `radial-gradient(ellipse at top, #2c2925 0%, ${BG} 50%, #1c1a18 100%)` }}>
      <nav className="sticky top-0 z-40 backdrop-blur-xl" style={{ background: `${BG}dd`, borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-8 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={openSignup} className="text-sm font-bold px-5 py-2 rounded-md transition-all"
              style={{ background: G, color: '#fff' }}
              onMouseEnter={e => (e.currentTarget.style.background = '#6fa23e')}
              onMouseLeave={e => (e.currentTarget.style.background = G)}>
              Try Free
            ...
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="pt-4 lg:pt-12">
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-3">
                <button onClick={openSignup}
                  className="group flex items-center justify-center gap-2.5 px-7 py-3.5 rounded-md font-bold text-sm transition-all"
        ...
        <div className="relative" style={{
          ...
          <div className="flex gap-4 animate-marquee" style={{ width: 'max-content' }}>
            {[...Array(2)].flatMap((_, dup) => ([
              ...
              <div
                key={`${dup}-${i}`}
                className="rounded-md p-4 flex-shrink-0"
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                ...
                className="rounded-md p-6 relative overflow-hidden group"
              ...
              >
                ...
                <div className="w-10 h-10 rounded-md flex items-center justify-center mb-4" style={{ background: `${G}15` }}>
      ...
      <section className="py-16 sm:py-20" style={{ borderTop: '1px solid rgba(255,255,255,0.04)' }}>
        <div className="max-w-lg mx-auto px-4 sm:px-8">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="rounded-md p-8 relative overflow-hidden"
            style={{
              background: CARD,
          ...
          >
            ...
            <button onClick={openSignup}
              className="w-full group flex items-center justify-center gap-2 py-3.5 rounded-md font-bold text-sm transition-all"
              style={{ background: G, color: '#fff', boxShadow: `0 4px 20px ${G}40` }}
              onMouseEnter={e => { e.currentTarget.style.background = '#6fa23e'; e.currentTarget.style.transform = 'translateY(-1px)'; }}
              onMouseLeave={e => { e.currentTarget.style.background = G; e.currentTarget.style.transform = 'translateY(0)'; }}>
              Analyze My Games Free
      ...
      <section className="py-20 sm:py-28" style={{ borderTop: '1px solid rgba(255,255,255,0.04)' }}>
        <div className="max-w-3xl mx-auto px-4 sm:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <div className="mt-8">
              <button onClick={openSignup}
                className="group inline-flex items-center justify-center gap-2 px-8 py-4 rounded-md font-bold text-sm transition-all"
                style={{ background: G, color: '#fff', boxShadow: `0 4px 20px ${G}40` }}
                onMouseEnter={e => { e.currentTarget.style.background = '#6fa23e'; e.currentTarget.style.transform = 'translateY(-1px)'; }}
                onMouseLeave={e => { e.currentTarget.style.background = G; e.currentTarget.style.transform = 'translateY(0)'; }}>
                Analyze My Games Free
      ...
      <div className="fixed bottom-0 left-0 right-0 z-30 sm:hidden p-3 bottom-nav-safe" style={{ background: `${BG}f0`, backdropFilter: 'blur(12px)', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        <button onClick={openSignup}
          className="w-full group flex items-center justify-center gap-2 py-3 rounded-md font-bold text-sm"
          style={{ background: G, color: '#fff' }}>
          Analyze My Games Free
          <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
        </button>
