...
export function Openings() {
  ...
  return (
    <div className="space-y-6 pb-20 px-4 pt-4 md:px-0 md:pt-0">
      ...
      {openings.length === 0 ? (
        <div className="text-center py-24 text-muted-foreground border-2 border-dashed border-border rounded-md">
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.06 }}
              className="glass-card rounded-md p-5 border-emerald-500/25">
              <p className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.15em] mb-2 flex items-center gap-1.5">
            ...
            <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.12 }}
              className="glass-card rounded-md p-5 border-red-500/25">
              <p className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.15em] mb-2 flex items-center gap-1.5">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="relative flex-1 max-w-sm">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 bg-secondary/70 border border-border rounded-md text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary/60 transition-all"
              />
            </div>
            <div className="flex rounded-md overflow-hidden border border-border text-sm font-bold">
          ...
          {/* Desktop (md+): table */}
          <div className="hidden md:block glass-card rounded-md overflow-hidden">
                      ...
                      >
                        <td className="px-4 py-3.5">
                          <div className="flex items-center gap-2.5">
                            {o.eco && (
                              <span className="shrink-0 px-2 py-0.5 rounded-md text-[10px] font-black bg-primary/15 text-primary border border-primary/25">
                                {o.eco}
                              </span>
                            )}
                        ...
                        <td className="px-4 py-3.5 text-center" onClick={e => e.stopPropagation()}>
                          <Link href={`/openings/${linkParam}`}
                            className="inline-flex items-center gap-1.5 px-3 py-2 rounded-md bg-primary/10 hover:bg-primary border border-primary/25 hover:border-primary text-primary hover:text-primary-foreground text-xs font-black transition-all">
                ...
                >
                  <div className="flex items-start justify-between gap-3 mb-3">
                    <div className="flex-1 min-w-0">
                      {o.eco && (
                        <span className="inline-block px-2 py-0.5 rounded-md text-[10px] font-black bg-primary/15 text-primary border border-primary/25 mb-1.5">
                          {o.eco}
                        </span>
                      )}
                  ...
                  <div className="flex items-center justify-between mt-3">
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-primary text-primary-foreground text-xs font-black transition-all hover:brightness-110"
                    >
                      <GraduationCap className="w-3.5 h-3.5" />
                      Practice &amp; Review
                    </Link>
