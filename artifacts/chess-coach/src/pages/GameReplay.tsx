    ...
    <div className="space-y-2 md:space-y-4 pb-20 px-3 pt-3 md:px-0 md:pt-0">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_340px] gap-6">
        ...
        <div className="space-y-2 md:space-y-4">
          ...
          <div className="glass-card rounded-2xl overflow-hidden">
            <div className="flex items-stretch">
              <div className="flex-1 flex items-center gap-2 px-3 py-2 md:py-3">
                {whitePlayer?.avatar
                  ? <img src={whitePlayer.avatar} alt={game.whiteUsername} className="w-7 h-7 md:w-9 md:h-9 rounded-lg md:rounded-xl object-cover border border-white/20 shrink-0" />
                  : <div className="w-7 h-7 md:w-9 md:h-9 rounded-lg md:rounded-xl bg-[#eeeed2] flex items-center justify-center shrink-0"><span className="text-[#2d2d2d] font-black text-xs md:text-sm">{game.whiteUsername[0]?.toUpperCase()}</span></div>
                }
                <div className="min-w-0">
              ...
              <div className="flex flex-col items-center justify-center px-2 md:px-3 border-x border-white/5 shrink-0">
                <span className={`px-2 py-0.5 md:px-2.5 md:py-1 rounded-lg text-[10px] md:text-[11px] font-black uppercase tracking-wider border
              ...
              <div className="flex-1 flex items-center gap-2 px-3 py-2 md:py-3 justify-end">
                ...
                {blackPlayer?.avatar
                  ? <img src={blackPlayer.avatar} alt={game.blackUsername} className="w-7 h-7 md:w-9 md:h-9 rounded-lg md:rounded-xl object-cover border border-white/20 shrink-0" />
                  : <div className="w-7 h-7 md:w-9 md:h-9 rounded-lg md:rounded-xl bg-[#2d2d2d] border border-white/20 flex items-center justify-center shrink-0"><span className="text-[#eeeed2] font-black text-xs md:text-sm">{game.blackUsername[0]?.toUpperCase()}</span></div>
                }
              </div>
            </div>
          </div>
          ...
          {/* Playback controls */}
          <div className="glass-card rounded-2xl px-1.5 py-1.5 md:p-3 flex items-center justify-between">
