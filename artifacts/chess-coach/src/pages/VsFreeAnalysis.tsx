...
export default function VsFreeAnalysisPage() {
  return (
    <VsPage
      ...
      title="ChessScout vs Free Chess.com Analysis — Honest Comparison"
      metaDescription="How ChessScout compares to free game review on Chess.com and Lichess."
