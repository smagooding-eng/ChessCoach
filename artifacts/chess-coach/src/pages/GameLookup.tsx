...
function AnalysisSummaryPanel({
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-md p-4 border" style={{ background: BG_CARD, border: CARD_BORDER, boxShadow: CARD_SHADOW }}>
    ...
    return (
      <div className="min-h-screen p-3 md:p-6" style={{ background: BG_DARK }}>
        <div className="max-w-7xl mx-auto">
          ...
          <div className="rounded-md border overflow-hidden" style={{ background: BG_CARD, border: CARD_BORDER, boxShadow: CARD_SHADOW }}>
            <div className="p-4 border-b flex flex-wrap items-center gap-4" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
              ...
              <div className="ml-auto flex items-center gap-2">
                {!isAnalyzing && analysis.length === 0 && (
                  <button
                    onClick={runAnalysis}
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-bold transition-all hover:opacity-90"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr_1fr] gap-0">
              ...
              <div className="flex flex-col border-l" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
                <div className="flex items-center justify-center gap-1 md:gap-2 p-2 border-b" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
                  <button onClick={goFirst} className="p-3 md:p-2 rounded-md hover:bg-white/10 active:scale-90 transition-transform" style={{ color: TEXT_MUTED }}><ChevronsLeft className="w-5 h-5 md:w-[18px] md:h-[18px]" /></button>
                  <button onClick={goPrev} className="p-3 md:p-2 rounded-md hover:bg-white/10 active:scale-90 transition-transform" style={{ color: TEXT_MUTED }}><ChevronLeft className="w-5 h-5 md:w-[18px] md:h-[18px]" /></button>
                  <button onClick={togglePlay} className="p-3 md:p-2 rounded-md hover:bg-white/10 active:scale-90 transition-transform" style={{ color: CHESSCOM_GREEN }}>
                    {isPlaying ? <Pause className="w-5 h-5 md:w-[18px] md:h-[18px]" /> : <Play className="w-5 h-5 md:w-[18px] md:h-[18px]" />}
                  </button>
                  <button onClick={goNext} className="p-3 md:p-2 rounded-md hover:bg-white/10 active:scale-90 transition-transform" style={{ color: TEXT_MUTED }}><ChevronRight className="w-5 h-5 md:w-[18px] md:h-[18px]" /></button>
                  <button onClick={goLast} className="p-3 md:p-2 rounded-md hover:bg-white/10 active:scale-90 transition-transform" style={{ color: TEXT_MUTED }}><ChevronsRight className="w-5 h-5 md:w-[18px] md:h-[18px]" /></button>
  ...
  return (
    <div className="min-h-screen p-3 md:p-6" style={{ background: BG_DARK }}>
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="rounded-md border p-5" style={{ background: BG_CARD, border: CARD_BORDER, boxShadow: CARD_SHADOW }}>
          <div className="flex flex-col sm:flex-row gap-3 items-end">
            <div className="flex-1 w-full">
              ...
              <input
                ...
                className="w-full px-3 py-2.5 rounded-md text-sm border outline-none focus:ring-1 transition-all"
                style={{
                  background: BG_DARK,
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-md font-bold text-sm transition-all hover:opacity-90 disabled:opacity-40 shrink-0"
              style={{ background: CHESSCOM_GREEN, color: '#fff' }}
            >
              {loading ? (
        ...
        {searchHistory.length > 0 && !loading && games.length === 0 && (
          <div className="rounded-md border p-4" style={{ background: BG_CARD, border: CARD_BORDER, boxShadow: CARD_SHADOW }}>
            ...
            <div className="flex flex-wrap gap-2">
              {searchHistory.map((h, i) => (
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 rounded-md text-sm transition-all hover:opacity-80"
        ...
        {error && (
          <div className="rounded-md p-3 text-sm border" style={{ background: 'rgba(220,67,67,0.1)', borderColor: 'rgba(220,67,67,0.3)', color: MISTAKE_RED }}>
            {error}
          </div>
        )}

        {hasSearched && !loading && games.length === 0 && !error && (
          <div className="text-center py-12 rounded-md border" style={{ background: BG_CARD, border: CARD_BORDER, boxShadow: CARD_SHADOW }}>
              ...
              {games.map(game => {
                ...
                return (
                  <button
                    ...
                    className="w-full text-left rounded-md border p-3 transition-all hover:border-[rgba(129,182,76,0.4)] group"
